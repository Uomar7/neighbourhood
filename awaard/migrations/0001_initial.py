# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2019-07-01 09:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_image', models.ImageField(default='award/media/images', upload_to='images/')),
                ('project_description', models.TextField()),
                ('link', models.URLField()),
                ('posted', models.DateTimeField(auto_now_add=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='awaard.Profile')),
            ],
        ),
        migrations.CreateModel(
            name='UsabilityRate',
